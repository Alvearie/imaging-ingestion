...
func GetEventDrivenIngestionResource(context context.Context, cr *v1alpha1.DicomStudyBinding, controllerClient client.Client) (*v1alpha1.DicomEventDrivenIngestion, error) {
