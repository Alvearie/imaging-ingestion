...
func (r *DimseIngestionServiceReconciler) reconcileInternal(currentState *DimseIngestionServiceState, cr *v1alpha1.DimseIngestionService) common.DesiredResourceState {
